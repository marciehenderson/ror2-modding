...
namespace BotanistMod.Survivors.Botanist.SkillStates
{
    public class ThrowBomb : GenericProjectileBaseState
    {
        ...
        //only modify this if you know what you're doing, otherwise it's best to keep it at 0
        ...
        {
            projectilePrefab = BotanistAssets.bombProjectilePrefab;
            //base.effectPrefab = Modules.Assets.SomeMuzzleEffect;
            //targetmuzzle = "muzzleThrow"

            attackSoundString = "BotanistBombThrow";
