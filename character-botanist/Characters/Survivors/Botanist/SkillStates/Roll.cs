...
namespace BotanistMod.Survivors.Botanist.SkillStates
{
    public class Roll : BaseSkillState
    {
        ...
        public static string dodgeSoundString = "BotanistRoll";
        ...
        public override void OnEnter()
        {
            ...
            {
                characterBody.AddTimedBuff(BotanistBuffs.armorBuff, 3f * duration);
        ...
        public override void FixedUpdate()
        {
            ...
            // replaced fovOverride with undeprecated option - may not work
            if (cameraTargetParams) cameraTargetParams.currentCameraParamsData.fov = Mathf.Lerp(dodgeFOV, 60f, fixedAge / duration);
        ...
        {
            // replaced deprecated fovOverride - may not work
            if (cameraTargetParams) cameraTargetParams.currentCameraParamsData.fov = -1f;
            base.OnExit();
