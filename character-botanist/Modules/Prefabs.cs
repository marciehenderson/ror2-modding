...
namespace BotanistMod.Modules
{
    ...
    internal static class Prefabs
    {
        ...
        private static void SetupCharacterBody(GameObject newBodyPrefab, BodyInfo bodyInfo)
        {
            ...
            bodyComponent.SetFieldValue("_defaultCrosshairPrefab", bodyInfo.crosshair);
        ...
        public static void ClearEntityStateMachines(GameObject bodyPrefab)
        {
            ...
            #pragma warning disable Publicizer001
            networkMachine.SetFieldValue("stateMachines", Array.Empty<EntityStateMachine>());
            #pragma warning restore Publicizer001
        ...
        public static void AddMainEntityStateMachine(GameObject bodyPrefab, string machineName = "Body", Type mainStateType = null, Type initalStateType = null)
        {
            ...
            {
                #pragma warning disable Publicizer001
                networkMachine.SetFieldValue("stateMachines", networkMachine.GetFieldValue<EntityStateMachine[]>("stateMachines").Append(entityStateMachine).ToArray());
                #pragma warning restore Publicizer001
            }
